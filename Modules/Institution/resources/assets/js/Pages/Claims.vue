                                ...
                                <table class="table table-striped">
                                    ...
                                    <template v-for="(row, i) in claimList">
                                        <tr v-if="row !== null">
                                            ...
                                            <td>${{ $amountPlusPyFee(parseFloat(row.registration_fee) + parseFloat(row.materials_fee) + parseFloat(row.program_fee) + parseFloat(row.correction), row.py_admin_fee) }}</td>
