...
//            'allocation' => $allocation
    ...
    public function exportCsv()
    {
        ...
        $csvDataHeader = ['PROGRAM NAME', 'SIN', 'FIRST NAME', 'LAST NAME', 'DOB', 'EMAIL', 'CITY',
            ...
            'EST. HOLD AMOUNT', 'CORRECTION', 'STABLE ENROL. DATE', 'EXPEC. STABLE ENROL. DATE', 'EXPECTED COMPLETION DATE', 'EXPIRY DATE','CLAIMED BY', 'ISSUE DATE', 'FEEDBACK',
        ...
        foreach ($data as $d) {
            $csvData[] = [$d->program->program_name, $d->sin, $d->first_name, $d->last_name, $d->dob, $d->email, $d->city,
                ...
                $d->estimated_hold_amount, $d->correction_amount, $d->stable_enrolment_date, $d->expected_stable_enrolment_date, $d->expected_completion_date,
