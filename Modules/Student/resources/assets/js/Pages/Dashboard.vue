        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-9 mb-3">
                    ...
                    <DashboardProfile v-bind="$attrs" v-if="page === 'profile' && individual_data == null" :error="error" :results="results" :provider-user="providerUser"></DashboardProfile>
                    <DashboardProfileWithPdex v-bind="$attrs" v-if="page === 'profile' && individual_data != null" :error="error" :results="results" :provider-user="providerUser"></DashboardProfileWithPdex>
                </div>
            </div>
        </div>
