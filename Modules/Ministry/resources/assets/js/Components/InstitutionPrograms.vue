<template>
    <div class="card">
        ...
        <div v-if="showNewModal" class="modal modal-xl fade" id="newInstProgramModal" tabindex="-1" aria-labelledby="newInstProgramModalLabel" aria-hidden="true" data-bs-backdrop="static">
        ...
        <div v-if="editProgram != ''" class="modal modal-xl fade" id="editInstProgramModal" tabindex="0" aria-labelledby="editInstProgramModalLabel" aria-hidden="true" data-bs-backdrop="static">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
